...
public class KlinikMataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klinik_mata);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaMata);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasMata);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanMata);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuPemesananMata);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterMata);

        findViewById(R.id.btDaftarMata).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        myRef.child("DokterMata").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(KlinikMataActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(KlinikMataActivity.this, DrawerActivity.class);
                        startActivity(i);
    ...
    private void AllertTampilJadwal() {
        ...
        alertDialogBuilder
                .setMessage("Senin – Jum’at\n" +
                        "14.00 – 16.00 : dr. Helen Nguda, Sp.M\n" +
                        "Senin – Rabu\n" +
                        "13.00 – 15.00 : dr. Hadijah, Sp.M\n" +
                        "\n" +
                        "Klinik Paru")
                .setIcon(R.mipmap.ic_launcher)
                .setCancelable(false)
