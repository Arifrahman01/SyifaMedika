...
public class KlinikTHTActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klinik_tht);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaTHT);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasTHT);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanTHT);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuTHT);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterTHT);

        findViewById(R.id.btDaftarTHT).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        myRef.child("DokterPenyakitDalam").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(KlinikTHTActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(KlinikTHTActivity.this, DrawerActivity.class);
                        startActivity(i);
