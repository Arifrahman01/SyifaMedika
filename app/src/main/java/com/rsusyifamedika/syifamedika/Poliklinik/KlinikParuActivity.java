...
public class KlinikParuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klinik_paru);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaParu);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasParu);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanParu);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuParu);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterParu);
        ...
        myRef.child("DokterParu").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(KlinikParuActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(KlinikParuActivity.this, DrawerActivity.class);
                        startActivity(i);
