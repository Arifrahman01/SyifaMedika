...
public class KlinikSyarafActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klinik_syaraf);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaSyaraf);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasSyarah);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanSyaraf);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuPemesananSyaeaf);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterSyaraf);
        ...
        myRef.child("DokterSyaraf").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(KlinikSyarafActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(KlinikSyarafActivity.this, DrawerActivity.class);
                        startActivity(i);
    ...
    private void AllertTampilJadwal() {
        ...
        alertDialogBuilder
                .setMessage("Senin – Sabtu\n" +
                        "07.30 – 09.00 : dr. Pagan Pambudi, Sp.S\n" +
                        "Senin – Jum’at\n" +
                        "17.00 – 18.00 : dr. Fatmawati, Sp.S\n" +
                        "19.00 – 21.00 : dr. Eko Suryo P., Sp.S")
                .setIcon(R.mipmap.ic_launcher)
                .setCancelable(false)
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    @Override
