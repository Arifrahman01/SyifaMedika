...
public class RehabMedikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rehab_medik);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaRM);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasRM);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanRM);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuRM);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterRM);

        findViewById(R.id.btDaftarParu).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        myRef.child("DokterPenyakitDalam").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(RehabMedikActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String poli = "Klinik Reham Medik";
                        ...
                        Intent i = new Intent(RehabMedikActivity.this, DrawerActivity.class);
                        startActivity(i);
    ...
    private void AllertTampilJadwal() {
        ...
        alertDialogBuilder
                .setMessage("Senin – Kamis\n" +
                        "Program Terapi  Rutin  : 14.30 – 16.00\n" +
                        "Konsultasi                        : 14.30 – 15.30\n" +
                        "\n" +
                        "Jum’at\n" +
                        "Program Terapi  Rutin  : 10.00 – 12.00\n" +
                        "Konsultasi                        : 11.00 – 12.00\n" +
                        "\n" +
                        "dr. Nur Yulia Sari, Sp.KFR")
                .setIcon(R.mipmap.ic_launcher)
                .setCancelable(false)
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    @Override
