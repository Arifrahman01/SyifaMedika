...
public class KlinikGigiBedahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klinik_gigi_bedah);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaGigiBedah);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasGigiBedah);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanGigiBedah);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuGigiBedah);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterGigiBedah);

        findViewById(R.id.btDaftarGigiBedah).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        myRef.child("DokterBedahMulut").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(KlinikGigiBedahActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
...
//                        AlertPenyakitDalam();
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String poli = "Klinik Gigi Spesialis Bedah Mulut";
                        ...
                        Intent i = new Intent(KlinikGigiBedahActivity.this, DrawerActivity.class);
                        startActivity(i);
    ...
    private void AllertTampilJadwal() {
        ...
        alertDialogBuilder
                .setMessage("Senin – Sabtu\n" +
                        "18.00 – 20.00 : drg. Mario Agung Asmara, Sp.BMM")
                .setIcon(R.mipmap.ic_launcher)
                .setCancelable(false)
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    @Override
