...
public class KlinikGigiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klinik_gigi);
        ...
        medNama1 = (EditText) findViewById(R.id.edNamaGigi);
        medNoIdenditas1 = (EditText) findViewById(R.id.edNoIdenditasGigi);
        medKeluhan1 = (EditText) findViewById(R.id.edKeluhanGigi);
        medPemesanan1 = (EditText) findViewById(R.id.edWaktuGigi);
        mspinnerDokterPenyakidDalam = (Spinner) findViewById(R.id.spinnerDokterGigi);

        findViewById(R.id.btDaftarGigi).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        myRef.child("DokterGigi").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(KlinikGigiActivity.this, android.R.layout.simple_spinner_dropdown_item, DokterPenyakitDalam);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(KlinikGigiActivity.this, DrawerActivity.class);
                        startActivity(i);
    ...
    private void AllertTampilJadwal() {
        ...
        alertDialogBuilder
                .setMessage("Senin – Jum’at\n" +
                        "09.00 – 13.00 : drg. Harinda Wahyu K.\n" +
                        "Senin & Rabu\n" +
                        "15.00 – 18.00 : drg. Nurul Husna\n" +
                        "Senin, Kamis, Jum’at\n" +
                        "15.00 – 18.00 : drg. Irna Noviantria")
                .setIcon(R.mipmap.ic_launcher)
                .setCancelable(false)
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    @Override
